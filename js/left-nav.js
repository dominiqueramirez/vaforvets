$(document).ready(function() {
	...
	$('.sub-sub-menu li:first-child').addClass('firstChild'); //Fix for IE borders only
	 ...
	 if($this.hasClass('head')) {
           $('.accordion li > a span').empty().append('<img src="/va_files/2014/responsive/images/left-nav/closed.png" title="Closed Arrow" alt="Closed Arrow" >');
           $('.sub-menu li > a span').empty().append('<img src="/va_files/2014/responsive/images/left-nav/sub-closed.png" title="Closed Arrow" alt="Closed Arrow" >');
           $('.sub-sub-menu li > a span').empty().append('<img src="/va_files/2014/responsive/images/left-nav/sub-closed.png" title="Closed Arrow" alt="Closed Arrow"  >');
	 };
    });
   ...
   $('.accordion li.head > a').on('click', function(e) {
		...
		if($parent.parent().hasClass('accordion')){
			$siblings.find('span').empty().append('<img src="/va_files/2014/responsive/images/left-nav/closed.png" title="Closed Arrow" alt="Closed Arrow" >');
			$siblings.find('ul').find('span').empty().append('<img src="/va_files/2014/responsive/images/left-nav/sub-closed.png" title="Closed Arrow" alt="Closed Arrow" >');
		}
		else {
			$siblings.find('span').empty().append('<img src="/va_files/2014/responsive/images/left-nav/sub-closed.png" title="Closed Arrow" alt="Closed Arrow" >');
		};
        ...
        if($parent.hasClass('active')) {
			if($parent.parent().hasClass('accordion')){
				$(this).find('span').first().empty().append('<img src="/va_files/2014/responsive/images/left-nav/open.png" title="Open Arrow" alt="Open Arrow" >');
			}
			else {
               $(this).find('span').first().empty().append('<img src="/va_files/2014/responsive/images/left-nav/sub-open.png" title="Open Arrow" alt="Open Arrow" >');
			};
        }
        else {
            if($parent.parent().hasClass('accordion')){
				$(this).find('span').first().empty().append('<img src="/va_files/2014/responsive/images/left-nav/closed.png" title="Open Arrow" alt="Closed Arrow" >');
	    }
            else {
               $(this).find('span').first().empty().append('<img src="/va_files/2014/responsive/images/left-nav/sub-closed.png" title="Open Arrow" alt="Closed Arrow">');
	    };
